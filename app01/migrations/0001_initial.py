# -*- coding: utf-8 -*-
# Generated by Django 1.11.4 on 2017-09-07 12:39
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nid', models.BigAutoField(primary_key=True, serialize=False, verbose_name='编号')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=32, verbose_name='分类标题')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('nid', models.BigAutoField(primary_key=True, serialize=False, verbose_name='编号')),
                ('name', models.CharField(max_length=64, verbose_name='个人博客标题')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('blog', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app01.MyBlog', verbose_name='所属博客')),
            ],
        ),
        migrations.CreateModel(
            name='UserFans',
        ...
        migrations.AddField(
            model_name='category',
            name='blog',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app01.MyBlog', verbose_name='所属博客'),
        ),
        migrations.AddField(
